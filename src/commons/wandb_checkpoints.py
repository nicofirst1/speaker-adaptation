...
INT_NOHIST_CE_CHK = dict(
    # epoch 10
    all="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_all:v216",
    food="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_food:v10",
    appliances="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_appliances:v216",
    indoor="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_indoor:v151",
    outdoor="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_outdoor:v213",
    vehicles="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_vehicles:v241",
)

INT_NOHIST_KL_CHK = dict(
    # epoch 20
    all="adaptive-speaker/interpreter-pretrain/InterpreterModel_no_hist_all:v29",
...
INT_TOM_CE_CHK = dict(
    # epoch 83
    all="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_all:v251",
    food="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_food:v97",
    appliances="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_appliances:v109",
    indoor="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_indoor:v129",
    outdoor="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_outdoor:v242",
    vehicles="adaptive-speaker/interpreter-pretrain/InterpreterModel_tom_vehicles:v205",
)

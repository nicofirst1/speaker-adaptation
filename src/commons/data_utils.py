...
def load_wandb_dataset(split: str, domain: str, load_params: Dict, list_vocab: Vocab,
                       speaker_model: torch.nn.Module,training_loader:DataLoader,logger,DATASET_CHK)->DataLoader:
    try:
        ...
        dl = speaker_augmented_dataloader(
            training_loader, list_vocab, speaker_model, split_name=split, load_params=load_params
        )

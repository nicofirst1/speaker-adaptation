...
class LeakFinder:
    ...
    def __init__(self, predict_every=20, verbose=True):
        self.step = 0  # used to keep track of the step in the batch
        self.batch = 0  # used to keep track of the batch
        self.values = {}
        self.predict_every = predict_every  # how often to predict the leak position
        self.verbose = verbose  # print the predicted leak position
    ...
    def find_leaks(self):
        ...
        print(
            f"Per batch increase: {per_epoch_increase_mean:.2f}% cuda memory "

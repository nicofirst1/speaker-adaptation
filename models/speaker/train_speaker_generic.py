...
if __name__ == '__main__':
    ...
    training_loader, test_loader, val_loader, training_beam_loader = get_dataloaders(args, vocab)
    ...
    for epoch in range(epochs):
        ...
        for i, data in rich.progress.track(enumerate(training_loader), total=len(training_loader),
            ...
            out = model(utterances_text_ids, lengths, prev_utterance_ids, prev_lengths, context_separate,
                        context_concat,
